#
# Module manifest for module 'PSGet_AzdoAPITools'
#
...
FunctionsToExport = 'Convert-AzDoAPIToolsYamlObjectToYAMLFile', 
               ...
               'Get-AzDoAPIToolsTaskGroupAsYAMLPrepped', 'Set-AzdoAPIToolsConfig'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'Powershell','AzurePipelines','YAML','VSTS','AzureDevops','Repository','BuildDefinition','ReleaseDefinition','TaskGroup'
