@{
    ...
    GUID = '679e7dd5-6298-48bd-90cb-3c426c061850'
    
    # Author of this module
    Author = 'Tobi Steenbakkers'
    
    # Company or vendor of this module
    CompanyName = 'Continuous Data'
    ...
    #FormatsToProcess = @('AzDoAPITools.Format.ps1xml')
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            LicenseUri = 'https://github.com/Continuous-Data/AzDoAPITools/blob/master/LICENSE'
    
            # A URL to the main website for this project.
            ProjectUri = 'https://github.com/Continuous-Data/AzDoAPITools'
